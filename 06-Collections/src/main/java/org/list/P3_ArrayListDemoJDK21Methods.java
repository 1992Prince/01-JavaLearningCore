...
public class P3_ArrayListDemoJDK21Methods {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("numsList before reversed() : " + numsList); // numsList before reversed() : [1, 2, 3, 4, 5]
        List<Integer> nums = numsList.reversed();
        System.out.println("numsList after reversed() : " + numsList); // numsList after reversed() : [1, 2, 3, 4, 5]
        System.out.println("Reveresed NumsList - " + nums); // Reveresed NumsList - [5, 4, 3, 2, 1]
        nums.add(0);
        System.out.println(nums); // [5, 4, 3, 2, 1, 0]
        System.out.println("numsList after modifying nums : " + numsList);
        // numsList after modifying nums : [0, 1, 2, 3, 4, 5]
