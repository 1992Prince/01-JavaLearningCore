...
public class P4_Arrays_asListDemo {
    ...
    public static void main(String[] args) {
        ...
        // older way of converting int[] to List<Integer>
        List<Integer> oldIntList = new ArrayList<>();
        for (int i : intArray) {
            oldIntList.add(i);
        }
        System.out.println("Old way of converting int[] to List<Integer>: " + oldIntList);
        // Old way of converting int[] to List<Integer>: [1, 2, 3]
